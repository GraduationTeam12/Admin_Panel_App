...
import '../../core/logic/add_owner_cubit/add_owner_and_hospital_state.dart';

class HospitalReports extends StatefulWidget {
  const HospitalReports({super.key});

  @override
  State<HospitalReports> createState() => _HospitalReportsState();
}

class _HospitalReportsState extends State<HospitalReports> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocListener<AddOwnerAndHospitalCubit, AddOwnerAndHospitalState>(
