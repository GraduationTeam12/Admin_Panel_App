...
class OwnerCharts extends StatefulWidget {
  const OwnerCharts({super.key});

  @override
  State<OwnerCharts> createState() => _OwnerChartsState();
}

class _OwnerChartsState extends State<OwnerCharts> {
