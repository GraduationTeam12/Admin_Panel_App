...
class ReportsHospitalInfoMobile extends StatefulWidget {
  const ReportsHospitalInfoMobile({super.key});

  @override
  State<ReportsHospitalInfoMobile> createState() =>
      _ReportsHospitalInfoMobileState();
}

class _ReportsHospitalInfoMobileState extends State<ReportsHospitalInfoMobile> {
  @override
  void initState() {
      ...
      child: BlocBuilder<AddOwnerAndHospitalCubit, AddOwnerAndHospitalState>(
        builder: (context, state) {
          ...
          return const Center(
            ...
            color: MyColors.premiumColor, // Loading indicator color
          ));
        },
      ),
    );
